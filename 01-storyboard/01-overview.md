...
- successful deployments: D3D project's use of DOF Alpha DAMAC implementation

- novel tools: DOF Initiative tools (including DOF Alpha)

- innovative workflows: the DAMAC approach

# Goal

Establish Docs-as-Models-as-Code as the way to document open source projects (hardware, science, software... everything)

# Title

This Is the Way... To Document Open Source
